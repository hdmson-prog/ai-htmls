  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.97]",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gold text-charcoal font-semibold tracking-wide uppercase text-xs hover:bg-gold-dark hover:text-primary-foreground rounded-none px-8 py-4 transition-all duration-300",
        "hero-outline": "border border-primary-foreground/40 text-primary-foreground font-light tracking-widest uppercase text-xs hover:bg-primary-foreground/10 rounded-none px-8 py-4 transition-all duration-300",
        luxury: "bg-charcoal text-ivory font-medium tracking-wider uppercase text-xs hover:bg-charcoal-light rounded-none transition-all duration-300",
        "luxury-outline": "border border-charcoal text-charcoal font-light tracking-widest uppercase text-xs hover:bg-charcoal hover:text-ivory rounded-none transition-all duration-300",
      },
      size: {
